defmodule GraphBLAS.Native do
  ...
  use Zig,
    ...
    nifs: [
      ...
      matrix_set_int64: [:dirty_cpu],
      matrix_set_fp64: [:dirty_cpu],
      matrix_set_bool: [:dirty_cpu],
      matrix_extract_int64: [:dirty_cpu],
      matrix_extract_fp64: [:dirty_cpu],
      matrix_extract_bool: [:dirty_cpu],
      matrix_dup: [:dirty_cpu],
      ...
      vector_set_int64: [:dirty_cpu],
      vector_set_fp64: [:dirty_cpu],
      vector_set_bool: [:dirty_cpu],
      vector_extract_int64: [:dirty_cpu],
      vector_extract_fp64: [:dirty_cpu],
      vector_extract_bool: [:dirty_cpu],
      vector_dup: [:dirty_cpu],

      # Descriptor management
      descriptor_create: [:dirty_cpu],
      descriptor_free: [:dirty_cpu],
      descriptor_is_custom: []
    ]
